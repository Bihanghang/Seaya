package com.bihang.seaya.enums;
...
public enum StatusEnum {
    ...
    /** 404 */
    NOT_FOUND("404", "Need to declare a method by using @SeayaRoute!"),

    /** IllegalArgumentException */
    ILLEGAL_PARAMETER("404", "IllegalArgumentException: You can only have two parameters at most by using @SeayaRoute!"),
    ;
